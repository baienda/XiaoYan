...
import com.baienda.xiaoyan.mvp.view.activity.GroupActivity;

/**
 * Created by Serenade on 2017/8/15.
 */

public class GroupPresenter extends MVPBasePresenter<GroupActivity> implements GroupContract.Presenter {
    @Override
    public void start() {
