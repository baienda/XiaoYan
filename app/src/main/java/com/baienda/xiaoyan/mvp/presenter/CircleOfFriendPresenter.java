...
import com.baienda.xiaoyan.mvp.model.CircleOfFriendModel;
...
public class CircleOfFriendPresenter extends MVPBasePresenter<CircleOfFriendActivity,CircleOfFriendModel>implements CircleOfFriendContract.Presenter {
    @Override
    public void start() {
