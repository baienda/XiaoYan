...
import com.baienda.xiaoyan.mvp.model.MainModel;
...
public class MainPresenter extends MVPBasePresenter<MainActivity,MainModel> implements MainContract.Presenter {
    @Override
    public void start() {
