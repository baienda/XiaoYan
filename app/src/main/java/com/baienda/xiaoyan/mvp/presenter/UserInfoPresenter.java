...
import com.baienda.xiaoyan.mvp.model.UserInfoModel;
...
public class UserInfoPresenter extends MVPBasePresenter<UserInfoActivity,UserInfoModel> implements UserInfoContract.Presenter {
    @Override
    public void start() {
